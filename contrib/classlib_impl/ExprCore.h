...
class ExprCore {
	...
	public:
		...
		ExprCore(ExprImp::Operator op, uint32_t lhs, const Expr &rhs);
		ExprCore(ExprImp::Operator op, int32_t lhs, const Expr &rhs);
		ExprCore(ExprImp::Operator op, const Expr &lhs, uint32_t rhs);
		ExprCore(ExprImp::Operator op, const Expr &lhs, int32_t rhs);
		ExprCore(ExprImp::Operator op, int32_t lhs, int32_t rhs);
		ExprCore(ExprImp::Operator op, uint32_t lhs, int32_t rhs);

		ExprCore(Import &import, const Expr &params);

		explicit ExprCore(ExprImp::Operator op);
