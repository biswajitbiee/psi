...
namespace pss {
  ...
  Constraint::Constraint() : BaseItem(new ConstraintImp(this)){}

  ConstraintImp::ConstraintImp(Constraint *master) : NamedBaseItemImp(master, BaseItemImp::TypeConstraint, nullptr){}

  Constraint::Constraint(const Expr &stmt) : BaseItem(new ConstraintImp(this, nullptr, "", stmt)){}
  ...
  ConstraintImp::ConstraintImp() : NamedBaseItemImp(nullptr, BaseItemImp::TypeConstraint, nullptr, "") 
  {
  }

  ConstraintImp& ConstraintImp::operator=(const ConstraintImp& c)
  {
    if(this != &c)
    {
      m_stmt = c.m_stmt;
